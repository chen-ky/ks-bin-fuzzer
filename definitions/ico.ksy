...
types:
  icon_dir_entry:
    ...
    instances:
      img:
      # How to let the compiler know when to generate png or bmp?
        pos: ofs_img
        size: len_img
        doc: |
      ...
      png_header:
        ...
        doc: |
          ...
          embedded PNG file.
      is_png:
      # This isn't part of the format. Maybe if something is in `instance` and
      # without `pos`, we can safely ignore it?
